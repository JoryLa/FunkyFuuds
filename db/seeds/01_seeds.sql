...
INSERT INTO items (item, description, price, cooking_time, thumbnail_photo) VALUES
  ...
  ('Seared burrito', 'Unexpected consequences', 600, 4, ''),
  ('Angry Perogies', 'Proceed with caution', 800, 8, ''),
  ('Furry Bagel', 'No questions asked', 250, 3, ''),
  ('Crunchy farmers wrap', 'For your dog maybe?', 150, 4, ''),
  ('Aged Crème Brulée', 'Chefs special', 300, 2, '');
